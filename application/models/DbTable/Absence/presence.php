 ...
 * @license    "New" BSD License
 */
class Model_DbTable_Absence_Presence extends Zend_Db_Table_Abstract
{
  ...
  public static function edit($id, $data)
  {
    ...
    $db->update('presence', $data, 'id_pres = ' . $id);
  }
   ...
   */
  public static function findByNom_presence($nom_absent)
  {
    $db = Zend_Registry::get('dbAdapter');

    $query = $db->select()
      ->from( array("a" => "presence") )
      ->where( "a.nom_pres = " . $nom_absent );

    return $db->fetchRow($query);
  }

  public static function ajout_presence($date,$nom_absent){
    try {
      //$db = Zend_Registry::get('dbAdapter');
